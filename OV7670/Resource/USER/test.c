...
void DrawTestPage(u8 *str)
{
	...
	Gui_StrCenter(0,lcddev.height-18,WHITE,BLUE,"By xiaobai",16,1);//居中显示
	//绘制测试区域
...
void Touch_Test(void)
{
	...
	POINT_COLOR=RED;
	LCD_Fill(lcddev.width-52,2,lcddev.width-50+20,18,RED); //显示图标大小
	while(1)
	{
	 	key=KEY_Scan();
		tp_dev.scan(0); 		 
